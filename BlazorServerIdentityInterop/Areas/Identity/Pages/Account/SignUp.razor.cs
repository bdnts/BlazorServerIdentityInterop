...
using BlazorServerIdentityInterop.Components;
...
namespace BlazorServerIdentityInterop.Areas.Identity.Pages.Account
{
    public partial class SignUp : ComponentBase
    {
        ...
        private async Task ValidSubmit()
        {
            ...
            EmailConfirmationUrl = await GetUrl(IdentityUser, IdentityUser.Id, navman.BaseUri, "SignUpEmailConfirmed");
        ...
        private async Task<bool> SignUpUser()
        {
            try
            {
                ...
                var result = await userManager.CreateAsync(IdentityUser, input.Password);
                if (!result.Succeeded)
                {
                ...
                IdentityUser = await userManager.FindByNameAsync(IdentityUser.UserName);
        ...
        public async Task<string> GetUrl(IdentityUser identityuser, string id, string baseuri, string path)
        {
            _logger.LogInformation("GetUrl");
